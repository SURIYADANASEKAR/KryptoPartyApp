...
public class HallService {
	...
	public List<Hall> getHallByCompany(String hall_id) {
		return hallRepo.getByAdminId(hall_id);
	}
	...
	public Users getProfileById(Long userId) throws Exception {
		return userRepo.findById(userId).orElseThrow(() -> new Exception("profile not found"));
	}
